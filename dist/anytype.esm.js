...
// Export Function
function any$1(name, value) {
  if (typeof name !== 'string') {
    throw new Error('Variable name must be a string');
  }
  return new AnyType$1(value, name);
}

function declareAny$1(variables) {
  const result = {};
  for (const [name, value] of Object.entries(variables)) {
    result[name] = any$1(name, value);
  }
  return result;
}
...
export { AnyType$1 as AnyType, any$1 as any, declareAny$1 as declareAny, index as default };
